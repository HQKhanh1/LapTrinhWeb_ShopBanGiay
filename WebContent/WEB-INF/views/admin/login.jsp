	...
	<div class="login-container">
        <div id="login" class="login-box">
            <div class="login-content">
                ...
                <h2>${tb}</h2>
                <h1>Đăng Nhập</h1>
                <form class="login-form" action="${pageContext.request.contextPath}/admin/login.htm" autocomplete="new-password">
                    <div class="usern">
                        <label for="uname"><b>Username</b></label>
                        <input autocomplete="new-password" type="text" placeholder="Enter Username" name="id" required>
                    </div>
                    <div class="usern">
                        <label for="psw"><b>Password</b></label>
                        <input autocomplete="new-password" type="password" placeholder="Enter Password" name="password" required>
                    </div>
                    <button >Login</button>
                </form>
