            ...
            <div class="login-content">
                ...
                <form class="login-form" action="${pageContext.request.contextPath}/home/login.htm" autocomplete="new-password" method="post">
                    <div class="usern">
                        ...
                        <input autocomplete="new-password" type="text" placeholder="Enter Username" name="user" required>
                    </div>
                    <div class="usern">
                        <label for="psw"><b>Password</b></label>
                        <input autocomplete="new-password" type="password" placeholder="Enter Password" name="pass" required>
                    </div>
                    <button >Login</button>
                </form>
